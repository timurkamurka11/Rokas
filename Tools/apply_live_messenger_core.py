...
message_path = Path("Assets/Rokas/Scripts/Core/MessageService.cs")
...
message = replace_once(
    ...
    "conversation live normalization")
...
message = replace_once(
    ...
    "entry live normalization")

message_path.write_text(message, encoding="utf-8")


game_path = Path("Assets/Rokas/Scripts/Core/GameSession.cs")
...
game = replace_once(
    ...
    "GameSession LiveMessages property")
game = replace_once(
    game,
    ...
    "GameSession live construction")
game = replace_once(
    game,
    '''        public void Tick(float seconds)\n        {\n            NotifyIf(Combat.Tick(seconds));\n        }\n''',
    '''        public void Tick(float seconds)\n        {\n            bool combatChanged = Combat.Tick(seconds);\n            LiveMessages.Tick(seconds);\n            NotifyIf(combatChanged);\n        }\n''',
    "GameSession live tick")
game_path.write_text(game, encoding="utf-8")


yumiko_test_path = Path("Tests/Core/YumikoFoodIntegrationTests.cs")
yumiko_test = yumiko_test_path.read_text(encoding="utf-8")
yumiko_test = yumiko_test.replace(
...
yumiko_test = replace_once(
    ...
    "Yumiko recommendation attachment regression")
yumiko_test_path.write_text(yumiko_test, encoding="utf-8")


live_service = r'''using System;
...
Path("Assets/Rokas/Scripts/Core/LiveMessengerService.cs").write_text(live_service, encoding="utf-8")
Path("Assets/Rokas/Scripts/Core/LiveMessengerService.cs.meta").write_text('''fileFormatVersion: 2\nguid: 93ac61b7548d4605b2b20d9d7adefd52\nMonoImporter:\n  externalObjects: {}\n  serializedVersion: 2\n  defaultReferences: []\n  executionOrder: 0\n  icon: {instanceID: 0}\n  userData:\n  assetBundleName:\n  assetBundleVariant:\n''', encoding="utf-8")

print("Applied Live Messenger core production patch")
